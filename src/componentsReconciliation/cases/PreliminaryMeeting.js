...
const PreliminaryMeeting = (props) => {
  ...
  const enableNextStep = (id) => {
    ...
    stepForm.append("step", 7);
    stepForm.append("stepName", "draft");
    axios
  ...
  const handleUpload = (file) => {
    ...
    form.append("type", "prelimMeeting");
    axios
      .post(
...
export default PreliminaryMeeting;

...
const InvitationForPreliminaryMeeting = (props) => {
  ...
  const enableNextStep = (id) => {
    ...
    stepForm.append("step", 6);
    stepForm.append("stepName", "meeting");
    axios
  ...
  const handleUpload = (file) => {
    ...
    form.append("type", "invitePrelimMeeting");
    axios
      .post(
  ...
  const docs = () => {
    return props.location.state.attachments.map((attach) => {
      if (attach.type == "invitePrelimMeeting") {
        index += 1;
        return (
          <tr key={attach._id}>
            ...
            {role == "admin" ? (
              <Breadcrumb>
                ...
                <BreadcrumbItem style={styles.crumb}>
                  Invitation for Prlimanary Meeting -{" "}
          ...
          <Col>
            ...
            <Card style={styles.cardBg}>
              <h6 className="pl-2" style={styles.center}>
                V. Invitation For Preliminary Meeting
...
export default InvitationForPreliminaryMeeting;

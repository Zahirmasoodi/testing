...
const InvitaionForHearing = (props) => {
  ...
  const handleNavigation = (data) => {
    props.history.push({
      pathname: "/email_/inviteHearing_",
      state: data,
    });
  };
  ...
  const enableNextStep = (id) => {
    ...
    stepForm.append("step", 9);
    stepForm.append("stepName", "hearing");
  ...
  const handleUpload = (file) => {
    ...
    form.append("type", "inviteHearing");
    axios
      .post(
...
export default InvitaionForHearing;

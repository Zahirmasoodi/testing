...
const NoticeOfArbitration = (props) => {
  ...
  const enableNextStep = (id) => {
    ...
    stepForm.append("step", 3);
    stepForm.append("stepName", "nomination");
    axios
            ...
            <span
              ...
              onClick={() => {
                if (role == "admin" && step < 3) {
                  ...
                  Swal.fire({
                    title: "Acces Denied, Contact IICRA",
                    icon: "error",
                  });
                }
              }}
...
export default NoticeOfArbitration;

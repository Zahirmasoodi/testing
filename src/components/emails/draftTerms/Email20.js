...
const Email20 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(`${baseURL}/email/arbTribunalConfirmReqRespondent`, formData)
      .then(() => {
        Swal.fire({
          title: "SENT",
          icon: "success",
  ...
  return (
    <>
      <Header
        ...
        stepPathPrev="draft"
        stepPath="draft"
        name="Arbitral Tribunal Confirmation to Extend the Deadline Submission of Documents - Respondent"
      />

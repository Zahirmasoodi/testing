...
const Email26 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(
        `${baseURL}/email/confirmFeedbackSoleArbitratorRespondent`,
        formData
      )
      .then(() => {
        Swal.fire({
  ...
  return (
    <>
      <Header
        ...
        stepPathPrev="draft"
        stepPath="draft"
        name="Confirmation for the Feedback on Draft TOR by Sole Arbitrator - Claimant"
      />
        ...
        <Card style={styles.cardBg}>
          ...
          <CardBody>
            ...
            <p>
              ...
              As per the Order No. ____ of the Sole Arbitrator, your

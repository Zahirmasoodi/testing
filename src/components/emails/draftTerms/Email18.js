...
const Email18 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(`${baseURL}/email/arbSoleConfirmReqRespondent`, formData)
      .then(() => {
        Swal.fire({
          title: "SENT",
          icon: "success",
  ...
  return (
    <>
      <Header
        ...
        stepPathPrev="draft"
        stepPath="draft"
        name="Sole Arbitrator Confirmation to Extend the Submission of Documents - Respondent"
      />
      <Container style={styles.formUserContainer} className="shadow-lg">
        ...
        <Card style={styles.cardBg}>
          ...
          <CardBody>
            ...
            <br />
            <p>
              As per the Order No. ____, the Sole Arbitrator grants the request
              of the Claimant to extend the submission of its document(s) until
              (Date).
              <br />

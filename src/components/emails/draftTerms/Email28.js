...
const Email28 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(
        `${baseURL}/email/confirmFeedbackArbitralTribunalRespondent`,
        formData
      )
      .then(() => {
        Swal.fire({
  ...
  return (
    <>
      ...
      <Header
        ...
        stepPathPrev="draft"
        stepPath="draft"
        name="Confirmation for the Feedback on Draft TOR by Arbitral Tribunal - Respondent"
      />

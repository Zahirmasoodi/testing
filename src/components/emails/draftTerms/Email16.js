...
const Email16 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(`${baseURL}/email/arbTribunalRejectedReqRespondent`, formData)
      .then(() => {
        Swal.fire({
          title: "SENT",
          icon: "success",
  ...
  return (
    <>
      <Header
        ...
        stepPathPrev="draft"
        stepPath="draft"
        name="Arbitral Tribunal Rejected the Request to extend the Deadline Submission of Documents - Respondent"
      />
      <Container style={styles.formUserContainer} className="shadow-lg">
        ...
        <Card style={styles.cardBg}>
          ...
          <CardBody>
            ...
            <br />
            <p>
              As per the Order No. ___, the Arbitral Tribunal would like to
              inform you that due to the irrational and invalid reason your
              request to extend the submission of documents has been rejected
              and will expect to submit the required documents on {Date.now()}.
            </p>
            <br />
            <h6>
              <b>

...
const Email58 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(`${baseURL}/email/tribunalRequestsDocumentsRespondent`, formData)
      .then(() => {
        Swal.fire({
          title: "SENT",
          icon: "success",
  ...
  return (
    <>
      <Header
        ...
        stepPath="memorandum"
        name="Arbitral Tribunal Requesting the Respondent to Submit the Required Documents"
      />

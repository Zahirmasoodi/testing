...
const Email55 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(`${baseURL}/email/soleRequestsDocumentsClaimant`, formData)
      .then(() => {
        Swal.fire({
          title: "SENT",
          icon: "success",
  ...
  return (
    <>
      <Header
        ...
        stepPath="memorandum"
        name="Sole Arbitrator Requesting the Claimant to Submit the Required Documents"
      />

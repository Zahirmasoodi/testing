...
const Email57 = (props) => {
  ...
  const handleSend = (data) => {
    ...
    axios
      .post(`${baseURL}/email/tribunalRequestsDocumentsClaimant`, formData)
      .then(() => {
        Swal.fire({
          title: "SENT",
          icon: "success",
  ...
  return (
    <>
      <Header
        ...
        stepPath="memorandum"
        name="Arbitral Tribunal Requesting the Claimant to Submit the Required Documents"
      />
      <Container style={styles.formUserContainer} className="shadow-lg">
        ...
        <Card style={styles.cardBg}>
          ...
          <CardBody>
            ...
            <p>
              <b>
                Subject: Requesting the Claimant to Submit the Required
                Document(s)
              </b>
            </p>
            ...
            <p>
              As per the Order No. ___ on (Date), the Arbitral Tribunal would
              like to request to the Claimant to produce the required
            ...
            <p>
              ...
              reputed Arbitral Tribunal the deadline for the above documents
              will be on (Date) and IICRA shall not received any documents
              submission thereafter until the Arbitral Tribunal advised
              otherwise.
              <br />

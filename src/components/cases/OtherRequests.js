...
const OtherRequests = (props) => {
  ...
  const enableNextStep = (id) => {
    ...
    stepForm.append("stepName", "requests");
    axios
            ...
            {role == "admin" ? (
              <Breadcrumb>
                ...
                <BreadcrumbItem style={styles.crumb}>
                  {document.dir == "ltr" ? "Other Requests" : "طلبات أخرى"} -
                  ARB
          ...
          <Col>
            ...
            <Card style={styles.cardBg}>
              <h6 className="pl-2" style={styles.center}>
                VII. {document.dir == "ltr" ? "Other Requests" : "طلبات أخرى"}
                {role == "admin" ? (

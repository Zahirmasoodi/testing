...
const Hearing = (props) => {
  ...
  const handleMinutes = (data) => {
    props.history.push({
      // pathname: "/cases/hearing/minutes",
            ...
            {role == "admin" ? (
              <Breadcrumb>
                ...
                <BreadcrumbItem style={styles.crumb}>
                  {document.dir == "ltr" ? "Hearing(s)" : "جلسات الاستماع"} -
                  ARB
          ...
          <Col>
            ...
            <Card style={styles.cardBg}>
              <h6 className="pl-2" style={styles.center}>
                IX. {document.dir == "ltr" ? "Hearing(s)" : "جلسات الاستماع"}
                <span style={{ float: "right" }}>
                  {role == "admin" ? (
                    ...
                    >
                      {document.dir == "ltr" ? "Templates" : "دقائق الاجتماع"}
                    </a>
                  ) : null}
                </span>
              </h6>

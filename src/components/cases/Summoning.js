...
const Summoning = (props) => {
  ...
  const enableNextStep = (id) => {
    ...
    stepForm.append("stepName", "summon");
    axios
            ...
            {role == "admin" ? (
              <Breadcrumb>
                ...
                <BreadcrumbItem style={styles.crumb}>
                  {document.dir == "ltr"
                    ? "Call Witness / Expert / Interpretor"
                    : "استدعاء شاهد / خبير / مترجم"}{" "}
                  - ARB
